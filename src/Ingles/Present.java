...
public class Present {
    ...
    public static void TimePresent() {
        try {
                    ...
                    if (m == 1) { // Tiene sujeto inico
                        ...
                        if (table == 1) { //Tabla verbos regulares inico
                            ...
                            if(rs.next()) {
                                ...
                                System.out.println("The sentence is: " + subject + " " + rs.getString(2) + " " + object + " " + complement);
                            }
                            else{
                        ...
                        if (c == 1) { //We inicio
                            ...
                            if (table == 1) { //Tabla regulares inicio
                                ...
                                if(rs.next()) {
                                    ...
                                    System.out.println("What's the complement of your sentence?");
                                    String complement = entrada.nextLine();
                                    System.out.println("The sentence is: We"+ " " + rs.getString(2) + " " + object + " " + complement);
                                }
                                else{
                        ...
                        if (c == 2) { //They inicio
                            ...
                            if (table == 1) { //Tabla regulares inicio
                                ...
                                if(rs.next()) {
                                    ...
                                    System.out.println("What's the complement of your sentence?");
                                    String complement = entrada.nextLine();
                                    System.out.println("The sentence is: They"+ " " + rs.getString(2) + " " + object + " " + complement);
                                }
                                else{
                                    System.out.println("Try with another verb");}
                            } //Tabla regulares final
                    ...
                    if (m == 1) { //Tiene sujeto inicio
                        ...
                        if (table == 1) { //Tabla regular inicio
                            ...
                            if(rs.next()) {
                                ...
                                System.out.println("What's the complement of your sentence?");
                                String complement = entrada.nextLine();
                                System.out.println("The sentence is: "+subject+ " " + rs.getString(3) + " " + object + " " + complement);
                            }
                            else{
                                System.out.println("Try with another verb");}
                        } //Tabla regular final
                        ...
                        if (c == 1) {// I inicio
                            ...
                            if (table == 1) { //TAbla regular inicio
                                ...
                                if(rs.next()) {
                                    ...
                                    System.out.println("What's the complement of your sentence?");
                                    String complement = entrada.nextLine();
                                    System.out.println("The sentence is: I"+ " " + rs.getString(3) + " " + object + " " + complement);
                                }
                                else{
                                    System.out.println("Try with another verb");}
                            } //Tabla regular final
                        ...
                        if (c == 2) { //He inicio
                            ...
                            if (table == 1) { //TAbla regular inicio
                                ...
                                if(rs.next()) {
                                    ...
                                    System.out.println("What's the complement of your sentence?");
                                    String complement = entrada.nextLine();
                                    System.out.println("The sentence is: He"+ " " + rs.getString(3) + " " + object + " " + complement);
                                }
                                else{
                                    System.out.println("Try with another verb");}
                            } //Tabla regular final
                        ...
                        if (c == 3) { //She inicio
                            ...
                            if (table == 1) { //TAbla regular inicio
                                ...
                                if(rs.next()) {
                                    ...
                                    System.out.println("What's the complement of your sentence?");
                                    String complement = entrada.nextLine();
                                    System.out.println("The sentence is: She"+ " " + rs.getString(3) + " " + object + " " + complement);
                                }
                                else{
                                    System.out.println("Try with another verb");}
                            } //Tabla regular final
                        ...
                        if (c == 4) { //You inicio
                            ...
                            if (table == 1) { //TAbla regular inicio
                                ...
                                if(rs.next()) {
                                    ...
                                    System.out.println("What's the complement of your sentence?");
                                    String complement = entrada.nextLine();
                                    System.out.println("The sentence is: You"+ " " + rs.getString(2) + " " + object + " " + complement);
                                }
                                else{
                                    System.out.println("Try with another verb");}
                            } //Tabla regular final
                        ...
                        if (c == 5) { //It inicio
                            ...
                            if (table == 1) { //TAbla regular inicio
                                ...
                                if(rs.next()) {
                                    ...
                                    System.out.println("What's the complement of your sentence?");
                                    String complement = entrada.nextLine();
                                    System.out.println("The sentence is: It"+ " " + rs.getString(3) + " " + object + " " + complement);
                                }
                                else{
                                    System.out.println("Try with another verb");}
                            } //Tabla regular final
                ...
                if (n == 1) { //singular inicio
                    ...
                    if (table == 1) { //Tabla verbos regulares inico
                        ...
                        if (j == 1) {
                            ...
                            String complement = entrada.nextLine();
                            while (rs.next()) {
                                System.out.println("The sentence is: " + subject + " is " + rs.getString(5) + " " + object + " " + complement);
                            }
                            rs.close();
                        }
                        ...
                        if (j == 2) {
                            while (rs.next()) {
                                System.out.println("The sentence is: " + subject + " is " + rs.getString(5) + " " + object );
                            }
                            rs.close();
                ...
                if (n == 2) { //singular inicio
                    ...
                    if (table == 1) { //Tabla verbos regulares inico
                        ...
                        if (j == 1) {
                            ...
                            String complement = entrada.nextLine();
                            while (rs.next()) {
                                System.out.println("The sentence is: " + subject + " are " + rs.getString(5) + " " + object + " " + complement);
                            }
                            rs.close();
                        }
                        ...
                        if (j == 2) {
                            while (rs.next()) {
                                System.out.println("The sentence is: " + subject + " are " + rs.getString(5) + " " + object );
                            }
                            rs.close();
